# Generated by Django 5.0.6 on 2026-06-02 00:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('posted', 'Posted'), ('cancelled', 'Dibatalkan')], default='draft', max_length=20, verbose_name='Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipe', models.CharField(choices=[('kas', 'Kas'), ('bank', 'Bank'), ('qris', 'QRIS'), ('ewallet', 'E-Wallet'), ('clearing', 'Clearing')], default='kas', max_length=20, verbose_name='Tipe')),
                ...
                ('dibuat_pada', models.DateTimeField(auto_now_add=True)),
                ('diubah_pada', models.DateTimeField(auto_now=True)),
                ('akun', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='kas_bank_accounts', to='akuntansi.akun', verbose_name='Akun CoA')),
                ('dibuat_oleh', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='kas_bank_accounts_created', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saldo_statement', models.DecimalField(decimal_places=2, default=0, max_digits=15, verbose_name='Saldo Statement')),
                ('selisih', models.DecimalField(decimal_places=2, default=0, max_digits=15, verbose_name='Selisih')),
                ('status', models.CharField(choices=[('draft', 'Draft'), ('reconciled', 'Direkonsiliasi'), ('cancelled', 'Dibatalkan')], default='draft', max_length=20, verbose_name='Status')),
                ('catatan', models.TextField(blank=True, null=True, verbose_name='Catatan')),
                ('dibuat_pada', models.DateTimeField(auto_now_add=True)),
                ('diubah_pada', models.DateTimeField(auto_now=True)),
                ('akun_kas_bank', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='rekonsiliasi', to='kas_bank.kasbankaccount', verbose_name='Akun Kas/Bank')),
                ('dibuat_oleh', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='kas_bank_reconciliations_created', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tanggal', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Tanggal')),
                ('tipe', models.CharField(choices=[('masuk', 'Masuk'), ('keluar', 'Keluar'), ('transfer_masuk', 'Transfer Masuk'), ('transfer_keluar', 'Transfer Keluar'), ('penyesuaian_masuk', 'Penyesuaian Masuk'), ('penyesuaian_keluar', 'Penyesuaian Keluar')], max_length=25, verbose_name='Tipe Mutasi')),
                ...
                ('dibuat_pada', models.DateTimeField(auto_now_add=True)),
                ('diubah_pada', models.DateTimeField(auto_now=True)),
                ('akun_kas_bank', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='mutasi', to='kas_bank.kasbankaccount', verbose_name='Akun Kas/Bank')),
                ('akun_lawan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='kas_bank_mutasi_lawan', to='akuntansi.akun', verbose_name='Akun Lawan')),
            ],
            options={
