...
class JurnalReverseView(UpdatePermissionMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # Cegah pembalikan ganda
        if jurnal.is_reversed:
            return JsonResponse({'success': False, 'message': 'Jurnal ini sudah dibalik sebelumnya.'}, status=400)
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            with transaction.atomic():
                ...
                # Semua closing entry berhasil — tandai periode sebagai tutup
