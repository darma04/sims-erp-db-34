"""
==========================================================================
 GUNICORN PRODUCTION CONFIG -- SIMS-Software+Accounting-Isolated-Database-36
==========================================================================
 Panduan deploy:
...
# ===== LOGGING =====
accesslog = "/var/log/gunicorn/sims_acc_db/access.log"
errorlog  = "/var/log/gunicorn/sims_acc_db/error.log"
loglevel  = "info"         # debug | info | warning | error | critical
capture_output = True      # Capture Django print() ke errorlog

# ===== PROCESS NAMING =====
proc_name = "sims_acc_db"
